...
public class P009 {
	...
	public static void main(String[] args) throws IOException {
		...
		File k32_f1 = new File("C:\\Users\\501-21\\\\Desktop\\kopo32\\Java\\심화\\실습데이터\\day_data\\A005930.csv");
		...
		while ((k32_readtxt = k32_br.readLine()) != null) {	// 파일에 내용이 있을 때 반복 수행
			...
			// 문자열이 A005930이면(substring, equals)
			if (k32_field.length > 2 && k32_field[2].replace("^", "").trim().substring(0,7).equals("A005930")) {
		...
		System.out.println("추출한 삼성전자(A005930) 항목 개수 : " + k32_wcnt);	// 삼성전자 항목 개수 출력
