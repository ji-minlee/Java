...
public class P010 {
	...
	public static void main(String[] args) throws IOException {
		...
		File k32_f1 = new File("C:\\Users\\501-21\\\\Desktop\\kopo32\\Java\\심화\\실습데이터\\day_data\\Date.csv");
		...
		while ((k32_readtxt = k32_br.readLine()) != null) {	// 파일에 내용이 있을 때 반복 수행
			...
			// 문자열이 20150205이면(substring, equals)
			if (k32_field.length > 2 && k32_field[1].replace("^", "").trim().substring(0,8).equals("20150205")) {
		...
		System.out.println("날짜의 모든 종목 개수 : " + k32_wcnt);	// 해당 날짜의 모든 종목 개수 출력
